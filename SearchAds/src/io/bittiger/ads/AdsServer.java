...
public class AdsServer {
	public static void main(String[] args) throws IOException {
		...
		String synonymsFilePath = args[4];
		int synonymsMemcachedPortal = 11212;
		String mysql_host = "127.0.0.1:3306";
		String mysql_db = "searchads";
		String mysql_user = "root";
		String mysql_pass = "bittiger2017";
		AdsEngine adsEngine = new AdsEngine(adsDataFilePath,budgetDataFilePath,synonymsFilePath,memcachedServer,memcachedPortal,synonymsMemcachedPortal, mysql_host,mysql_db,mysql_user,mysql_pass);
		if(adsEngine.init())
		{
