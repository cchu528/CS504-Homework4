...
public class SearchAds extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
	    ...
	    String synonymsFilePath = application.getInitParameter("synonymsFilePath");
		...
		this.adsEngine = new AdsEngine(adsDataFilePath,budgetDataFilePath,synonymsFilePath,memcachedServer,memcachedPortal,synonymsMemcachedPortal, mysqlHost,mysqlDb,mysqlUser,mysqlPass);
		this.adsEngine.init();  
